...
static acdStatus RdGlobalVars(CmdInOut* cmdInOut)
{
    ...
    strcmp_s(peci_addr, strnlen_s(peci_addr, sizeof(peci_addr)),
    ...
    strcmp_s(cpuid, strnlen_s(cpuid, sizeof(cpuid)), cmdInOut->out.stringVal,
             &mismatchcpuid);
    if (mismatchcpuid == 0)
    {
    ...
    strcmp_s(cpuid_source, strnlen_s(cpuid_source, sizeof(cpuid_source)),
    ...
    strcmp_s(coremask, strnlen_s(coremask, sizeof(coremask)),
             cmdInOut->out.stringVal, &mismatchchcoremask);
    ...
    strcmp_s(chacount, strnlen_s(chacount, sizeof(chacount)),
    ...
    strcmp_s(corecount, strnlen_s(corecount, sizeof(corecount)),
    ...
    strcmp_s(crashcorecount, strnlen_s(crashcorecount, sizeof(crashcorecount)),
    ...
    strcmp_s(crashcoremask, strnlen_s(crashcoremask, sizeof(crashcoremask)),
